...
function SignIn({ handleLogin }: any) {
  ...
  const handleSubmit = (e: any): void => {
    ...
    let lastnameDone = lastname
      ? (setIsLastnameError(false), true)
      : (setIsLastnameError(true), false);
    let firstnameDone = firstname
      ? (setIsFirstnameError(false), true)
      : (setIsFirstnameError(true), false);
    let emailDone = email
      ? (setIsEmailError(false), true)
      : (setIsEmailError(true), false);
    let phoneDone = false;
      ...
      >
        ...
        <div className="col-10 m-auto mb-5 row">
          ...
          <input
            ...
            className={isLastnameError ? "error form-control" : "form-control"}
          />
          {isLastnameError && (
        ...
        <div className="col-10 m-auto mb-5 row">
          ...
          <input
            ...
            className={isFirstnameError ? "error form-control" : "form-control"}
          />
          {isFirstnameError && (
        ...
        <div className="col-10 m-auto mb-5 row">
          ...
          <input
            ...
            className={isEmailError ? "error form-control" : "form-control"}
          />
          {isEmailError && (
            <p style={{ color: "red" }}>Saisissez votre adresse e-mail</p>
          )}
          {isEmailAlreadyExist && (
            <p style={{ color: "red" }}>
        ...
        <div className="col-10 m-auto mb-5 row">
          ...
          <input
            ...
            className={isPhoneError ? "error form-control" : "form-control"}
          />
          {isPhoneError && <p style={{ color: "red" }}>{phoneErrorMessage}</p>}
        </div>
        <div className="col-10 m-auto mb-5 row">
          <label htmlFor="password" className="d-flex justify-content-start">
            MOT DE PASSE *{" "}
            <img
              className="info_password ms-4"
              src={info}
              alt="closeEye"
              data-toggle="tooltip"
              data-placement="top"
              title="Minimum 12 caractères, minimum une lettre majuscule, une lettre minuscule, un chiffre et un caractere special"
            />
          </label>
          <input
            name="password"
            ...
            className={isPasswordError ? "error form-control" : "form-control"}
          />
          {!isShowPassword && (
            <img
              className={isPasswordError ? " eyeError ms-4" : "eye ms-4"}
              src={closeEye}
              alt="closeEye"
        ...
        <div className="col-10 m-auto mb-5 row">
          ...
          <input
            ...
            className={
              isPasswordConfirmError ? "error form-control" : "form-control"
            }
          />
          {!isShowPasswordConfirm && (
            <img
              className={isPasswordConfirmError ? " eyeError ms-4" : "eye ms-4"}
              src={closeEye}
              alt="closeEye"
        ...
        <div className="row">
          <button type="submit" className="btn btn-primary col-5 m-auto  mt-4">
            S'inscrire
          </button>
        </div>
      </form>
